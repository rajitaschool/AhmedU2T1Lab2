...
public class RectangleRunner {
    public static void main(String[] args) {
        ...
        System.out.println("Rectangles 1's Area: " + rect1.calculateArea() + ", Box Volume: " + rect1.calculateBoxVolume(rect1Height));

        Rectangle rect2 = new Rectangle(rect2Length, rect2Width);
        System.out.println("Rectangles 2's Area: " + rect2.calculateArea() + ", Box Volume: " + rect2.calculateBoxVolume(rect2Height));
